...
static const Rule rules[] = {
	/* app_id             title       tags mask     isfloating   monitor */
        { "foot",             NULL,       1,            0,           -1 },
	{ "librewolf",        NULL,	  2,		0,	     -1 },
        { "nemo",             NULL,       1 << 2,       0,           -1 },
        { "FreeTube",         NULL,       1 << 3,       0,           -1 },
        { "mpv",              NULL,       1 << 4,       0,           -1 },
        { "anydesk",          NULL,       1 << 8,       0,           -1 },
};
...
static const char *freet[]    = { "freetube", NULL };
static const char *anyd[]    = { "anydesk", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,		     XKB_KEY_Return,     spawn,          {.v = termcmd} },
        ...
        { MODKEY,                    XKB_KEY_x,          spawn,          {.v = file} },
        { MODKEY,                    XKB_KEY_w,          spawn,          {.v = freet } },
        { MODKEY,                    XKB_KEY_a,          spawn,          {.v = anyd } },
